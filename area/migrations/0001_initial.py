# Generated by Django 3.2.7 on 2022-06-18 06:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='area.hood')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hood_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='area.hood')),
        ...
        migrations.AddField(
            model_name='hood',
            name='location',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='area.location'),
        ),
        migrations.AddField(
            model_name='hood',
            name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hood', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='biz', to='area.hood')),
